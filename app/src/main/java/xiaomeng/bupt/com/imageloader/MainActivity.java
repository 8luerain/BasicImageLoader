package xiaomeng.bupt.com.imageloader;
...
import xiaomeng.bupt.com.imageloader.adapter.GridViewAdapterContent;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ViewStub mViewStubLoadFailed;
    private GridViewAdapterContent mGridViewAdapterContent;
    ...
    private void initVariables() {
        mUrls = new ArrayList<>();
        mUrls = Arrays.asList(imageThumbUrls);
    }

    private void initViews() {
        mViewStubLoadFailed = (ViewStub) findViewById(R.id.layout_main_load_failed);
        mVelocityTrackGridview = (VelocityTrackGridview) findViewById(R.id.grid_view_content);
        mGridViewAdapterContent = new GridViewAdapterContent(this, R.layout.item_grid_view_content);
        mGridViewAdapterContent.setmUrls(mUrls);
        mGridViewAdapterContent.setVelocityTrackGridview(mVelocityTrackGridview);
        mVelocityTrackGridview.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                if (scrollState == SCROLL_STATE_IDLE) {
                    mGridViewAdapterContent.setScollIdel(true);
                    mGridViewAdapterContent.notifyDataSetChanged();
                } else {
                    mGridViewAdapterContent.setScollIdel(false);
                }
            }

            @Override
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                Log.d(TAG, "onScroll: view scrollY [" + view.getTranslationY() + "]");

            }
        });
        mVelocityTrackGridview.setAdapter(mGridViewAdapterContent);
    }
}
